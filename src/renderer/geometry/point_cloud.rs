...
pub use three_d_asset::PointCloud as CpuPointCloud;
...
impl PointCloud {
    ...
    ///
    pub fn new(context: &Context, cpu_point_cloud: CpuPointCloud) -> Self {
        ...
        point.transform(&Mat4::from_scale(0.001)).unwrap();

        Self(InstancedMesh::new(context, &instances, &point))
    }
}
