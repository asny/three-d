...
impl FXAAEffect {
    ...
    pub fn apply(&self, viewport: Viewport, color_texture: &Texture2D) -> Result<(), Error>
    {
        let render_states = RenderStates {cull: CullType::Back, depth_mask: false, depth_test: DepthTestType::Always, viewport, ..Default::default()};
