...
impl GUI {
    ...
    fn paint_mesh(
        ...
        let clip_max_x =
            egui::emath::clamp(clip_max_x, clip_min_x..=(width as f32 * pixels_per_point));
        let clip_max_y =
            egui::emath::clamp(clip_max_y, clip_min_y..=(height as f32 * pixels_per_point));
        ...
        let viewport = Viewport {
            x: clip_min_x,
            y: (height * pixels_per_point as usize) as i32 - clip_max_y,
            width: (clip_max_x - clip_min_x) as usize,
            height: (clip_max_y - clip_min_y) as usize,
        };
