...
fn main() {
    ...
    {
        let (statue_cpu_meshes, statue_cpu_materials) = Deserialize::obj(loaded, "examples/assets/COLOMBE.obj").unwrap();
        ...
        let (fountain_cpu_meshes, fountain_cpu_materials) = Deserialize::obj(loaded, "examples/assets/pfboy.obj").unwrap();
